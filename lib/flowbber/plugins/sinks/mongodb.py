...
The default is ``timestamp.epoch`` which assumes that your pipeline had
...
This option is nullable, and if null is provided, the object id will be
generated by MongoDB itself.
